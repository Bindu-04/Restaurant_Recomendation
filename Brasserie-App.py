...
#Linking essentials
csvFileLink = r'C:\Users\bindu\Downloads\GUI-based-Restaurant-Recommendation-System-master\NewZomato.csv'
backgroundImageLink = r'C:\Users\bindu\Downloads\GUI-based-Restaurant-Recommendation-System-master\images\sizller-with-noodles22.jpg'
searchIconLink = r'C:\Users\bindu\Downloads\GUI-based-Restaurant-Recommendation-System-master\images\icons8-search-50(2).png'
backGround2ImageLink= r'C:\Users\bindu\Downloads\GUI-based-Restaurant-Recommendation-System-master\images\Sitting-near-table-darkened.jpg'
backButtonImageLink =r'C:\Users\bindu\Downloads\GUI-based-Restaurant-Recommendation-System-master\images\icons8-back-50.png'
...
class RestaurantData:
        ...
        def RestaurantRecommendFunc(self,location,title):
            ...
            #Feature Extraction
            data_sample = data_sample.copy()  # Create explicit copy to avoid SettingWithCopyWarning
            data_sample['Split']='X'
            ...
            data_x =data_sample[['Restaurant Name','Cuisines','Aggregate rating']].iloc[rest_indices].copy()
