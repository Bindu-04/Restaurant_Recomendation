...
data = pd.read_csv(r'C:\Users\bindu\Downloads\GUI-based-Restaurant-Recommendation-System-master\zomato.csv', encoding ='latin1')
...
def restaurant_recommend_func(location,title):
    ...
    data_sample = data_new_delphi.loc[data_new_delphi['Locality'] == location].copy() # data frame
    #print(data_sample)
...
tabledata = restaurant_recommend_func('Connaught Place','Star Bakery')
